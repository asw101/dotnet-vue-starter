...
```sh
docker build -t dotnet_vue_starter .
docker run -p 8080:80 dotnet_vue_starter
# open http://localhost:8080
```

## Questions? Issues?

The [GitHub repo for this template is here](https://github.com/robconery/dotnet_vue_starter). I don't have discussions enabled, but feel free to pop an issue if you like or, better yet, a PR!
